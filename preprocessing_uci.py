"""
    ...
    yugos: 'D:\Fedra\iCloudDrive\Mcc\Tesis\Instancias\\breast_cancer_uci\\breast_cancer.csv'
...
class Preprocessing:
    ...
    def Outlier_detection(self):
        ...
        self.y = self.y[self.X.index] #for BC_coimbria, uci
...
if __name__ == "__main__":
    ...
    test = Preprocessing(path='D:\Fedra\coevolutivo\Instancias\\breast_cancer_uci\\breast_cancer.csv') #double bacl slash bc of the letter b? \\b
